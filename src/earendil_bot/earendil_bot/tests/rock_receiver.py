...
class RockReceiverNode(Node):
    def __init__(self):
        ...
        self.get_logger().info(f"Rock Receiver started. Listening on UDP port {self.port_recv}.")
    ...
    def stop_jetson_perception(self):
        ...
        self.get_logger().info("Shutting down Rock Receiver. Sending STOP command to Jetson...")
